...
<div class="bx_section">
	...
	if(!empty($arResult["DELIVERY"]))
	{
		...
		?>
		<div class="col-xs-12 col-sm-3"><h4><?=GetMessage("SOA_TEMPL_DELIVERY")?></h4></div>
		...
		foreach ($arResult["DELIVERY"] as $delivery_id => $arDelivery)
		{
            ...
            <div class="col-xs-12 col-md-6" style="padding-left: 0;"><div class="bx_block w100 vertical">
                ...
                <div class="bx_element">
                    ...
                    <label for="ID_DELIVERY_ID_<?= $arDelivery["ID"] ?>">
                        ...
                        <div class="bx_logotype"><span style='background-image:url(<?= $deliveryImgURL ?>);' onload="fShowStore('2','N','700','s1')"></span></div>
                        <!--                        default parameter on click --><?//=$clickHandler
                        ?>
                        ...
                        <div class="bx_description">
                            ...
                            ?>
                            <!---->
                            <!--							</span><span class="bx_result_price">-->
                            <!--								--><?//if(isset($arDelivery["PRICE"]))
                            //								{
                            //
                            //									echo GetMessage("SALE_DELIV_PRICE").": <b>";
                            ...
                            <!---->
                            <!--							</span>-->
                            <div style="visibility: hidden;height: 0"><? print_r($arResult["STORE_LIST"][$arResult["BUYER_STORE"]]); ?></div>
                            <p>
                                <?
