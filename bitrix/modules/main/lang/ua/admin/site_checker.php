...
Еталонна <a href=\"http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37\"> віртуальна машина & quot; 1С-Бітрікс & quot; </a> має оцінку близько 30 одиниць.
...
";
$MESS["SC_HELP_CHECK_CA_FILE"] = "Тест намагається підключитися до сайту www.1c-bitrix.ru.

Це необхідно для повсякденної роботи при використанні хмарних сервісів & quot; 1С-Бітрікс & quot; (CDN, хмарний бекап, сканер безпеки та ін.), Коли оновлюється інформація про квоти і поточний статус сервісів. При цьому ніякі дані користувача не передаються до нас на сервер.
...
";
$MESS["SC_HELP_CHECK_PULL_STREAM"] = "Для повноцінної роботи чату необхідна настройка модуля <a href=\"http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2033\"> Push and Pull </a>.

Модуль забезпечує миттєву доставку повідомлень у веб-мессенджер, мобільний додаток, а також моментальне оновлення живої стрічки.

Для цього повинен бути налаштований модуль сервера Nginx: push-stream-module. <a href=\"http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37\"> Віртуальна машина & quot; 1С-Бітрікс & quot; </a> з версії 4.2 має повну підтримку цього модуля .
";
...
Для цього повинен бути налаштований модуль сервера Nginx: push-stream-module. <a href=\"http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37\"> Віртуальна машина & quot; 1С-Бітрікс & quot; </a> з версії 4.2 має повну підтримку цього модуля .
";
$MESS["SC_HELP_CHECK_SOCNET"] = "Щоб отримувати в живу стрічку порталу повідомлення з соціальних мереж, необхідно <a href=\"http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=3040\">настроить</a> модуль соціальних сервісів, вказавши ключі для кожного сервісу окремо.";
...
Завдання налаштування NTLM в середовищі Linux нетривіальне, але на <a href=\"http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37\"> віртуальній машині & quot; 1С-Бітрікс & quot; </a> з версії 4.2 це налаштоване, потрібно тільки включити через майстер налаштування машини.
";
...
На сервері повинен бути налаштований модуль Nginx: push-stream-module. <a href=\"http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37\"> Віртуальна машина & quot; 1С-Бітрікс & quot; </a> з версії 4.2 має повну підтримку цього модуля .

Якщо пряме мережеве з'єднання браузерів неможливо, потрібен спеціальний TURN сервер. Компанія & quot; 1С-Бітрікс & quot; безкоштовно надає для своїх клієнтів налаштований TURN сервер за адресою: turn.calls.bitrix24.com, який використовується за умовчанням. Ви можете налаштувати власний сервер і вказати його адресу в налаштуваннях модуля & quot; веб-месенджер & quot; (im).
";
$MESS["SC_HELP_CHECK_PUSH_BITRIX"] = "Модуль <a href=\"http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2033\"> Push and Pull </a> забезпечує миттєву передачу повідомлень за технологією Pull і відправлення повідомлень на мобільні пристрої за технологією Push в <a href=\"http://www.1c-bitrix.ru/products/intranet/features/mobileapp.php\"> мобільний додаток 1С-Бітрікс </a>.

Відправка повідомлень на Apple і Android пристрою здійснюється через єдиний сервіс 1С-Бітрікс https://cloud-messaging.bitrix24.com через HTTPS.

Для роботи push повідомлень на мобільні пристрої повинна бути можливість доступу з порталу на цей сервер.
";
$MESS["SC_HELP_CHECK_ACCESS_MOBILE"] = "Для роботи мобільного додатку потрібен доступ до порталу з Інтернету.
...
У налаштуваннях <a href=\"/bitrix/admin/settings.php?mid=main\"> головного модуля </a> необхідно включити відповідну опцію. <a href=\"http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37\"> Віртуальна машина & quot; 1С-Бітрікс & quot; </a> має підтримку цієї можливості за замовчуванням.
";
...
";
$MESS["SC_HELP_CHECK_SEARCH"] = "Для пошуку по вмісту документів потрібно <a href=\"http://dev.1c-bitrix.ru/learning/course/?COURSE_ID=48&CHAPTER_ID=04759\"> налаштування </a> зовнішніх інструментів. У налаштуваннях модуля <a href=\"/bitrix/admin/settings.php?mid=intranet\"> intranet </a> повинні бути вказані коректні шляхи до цих додатків. Інакше пошук документів на порталі можливий тільки по імені файлу.

<a href=\"http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37\"> Віртуальна машина & quot; 1С-Бітрікс & quot; </a> має підтримку цієї можливості за замовчуванням.
";
