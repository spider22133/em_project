...
$MESS['FB_SUCCESS'] = '<a href="#URL#" target="_blank">Recording</a> "#ACC_NAME#" successfully published';
...
$MESS['FB_WARNING_NOT_URL'] = '<a href="#URL#" target="_blank">Recording</a> "#ACC_NAME#" successfully published, but was not attached picture, as you do not set the "Link to element"';
$MESS['FB_WARNING_INCORRECT_URL'] = '<a href="#URL#" target="_blank">Recording</a> "#ACC_NAME#" has been successfully published. But there was an error with the code "#CODE#" associated with the wrong link attached to "#ULINK#" when you publish <a href="/bitrix/admin/iblock_element_edit.php?IBLOCK_ID=#IBLOCK_ID#&type=#IBLOCK_TYPE#&ID=#ID#">element</a>:<br/>
#MESSAGE# <br/>';
$MESS['FB_SUCCESS_DELETE'] = '<a href="#URL#" target="_blank">Recording</a> "#ACC_NAME#" successfully removed';
$MESS['FB_ERROR_DELETE'] = 'Error code "#CODE#" in the account "#ACC_NAME#" if you delete<a href="#URL#" target="_blank">recording</a>:<br/>
#MESSAGE# <br/>';
