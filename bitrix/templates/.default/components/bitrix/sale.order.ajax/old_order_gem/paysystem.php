...
<div class="section">
    ...
    <div class="bx_section">
        ...
        {
        ?>
        <div class="col-sm-3"><h4><?= GetMessage("SOA_TEMPL_PAY_SYSTEM") ?></h4></div>
        <div class="col-sm-9">
            <?
            }
...
<div class="bx_section">
    <div class="col-sm-3"><h4><?= GetMessage("SOA_TEMPL_SUM_COMMENTS") ?></h4></div>
    <div class="col-sm-9 ">
        <div class="bx_block w100"><textarea name="ORDER_DESCRIPTION" id="ORDER_DESCRIPTION" style="max-width:100%;min-height:90px"><?= $arResult["USER_VALS"]["ORDER_DESCRIPTION"] ?></textarea></div>
