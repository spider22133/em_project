...
$MESS["MAIN_SITE_SPEED_NOTES"] = "<b> Вивід сторінки </b> & mdash; час від початку переходу на сторінку до появи її на екрані. Саме з цього показники вважається <b> Швидкість сайту </b>. <br><B> DNS </b> & mdash; час виконання запиту DNS для сторінки. <br><b> Підключення до сервера </b> & mdash; скільки часу комп'ютер користувача встановлює з'єднання з сервером. <br><b> Відповідь сервера </b> & mdash; час обробки сервером запиту користувача (включаючи час реакції мережі для розташування користувача). <br><b> Завантаження HTML </b> & mdash; час завантаження HTML сторінки без ресурсів (картинки, CSS, Javascript). <br><b> Обробка HTML </b> & mdash; час, протягом якого браузер обробляв вміст сторінки (синтаксичний аналіз HTML, CSS, обробка елементів JavaScript і відображення сторінки) після завантаження її з сервера і до початку отрисовки. <br>";
