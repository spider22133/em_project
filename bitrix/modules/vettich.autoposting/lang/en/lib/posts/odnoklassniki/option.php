...
$MESS['YES'] = 'Yes';
$MESS['NO'] = 'No';
$MESS['POST_ODNOKLASSNIKI_PUBLISH_DATE_HELP'] = 'Select the date for the postponed publication, usually "DATE_ACTIVE_FROM". The delayed publishing mechanism is implemented in the SOC. network. (optional)';
$MESS['POST_ODNOKLASSNIKI_PHOTO_HELP'] = 'Click main image to attach it to publication. (optional)';
$MESS['POST_ODNOKLASSNIKI_PHOTO_OTHER_HELP'] = 'Select additional images to be attached to the publication. (optional)';
$MESS['POST_ODNOKLASSNIKI_LINK_HELP'] = 'Select the field from which will form the reference attached to the publication. (optional)';
$MESS['POST_ODNOKLASSNIKI_MESSAGE_DESCRIPTION'] = '';
$MESS['SAVE_BUTTON'] = 'Save';
$MESS['APPLY_BUTTON'] = 'Apply';
$MESS['ODNOKLASSNIKI_TAB_VIDEO_NAME'] = 'Video instruction';
$MESS['ODNOKLASSNIKI_TAB_VIDEO_TITLE'] = 'Video instruction';
$MESS['ODNOKLASSNIKI_EDIT_PAGE_TITLE'] = 'Edit account Odnoklassniki';
$MESS['POST_ODNOKLASSNIKI_MESSAGE_HELP'] = 'Fill in the message template. This field is <b>required</b> - if not filled fields for attachments (images, link)';
$MESS['ODNOKLASSNIKI_ADD_PAGE_TITLE'] = 'Add account Odnoklassniki';
$MESS['ODNOKLASSNIKI_MESSAGE_DEFAULT'] = '#NAME#
#PREVIEW_TEXT#';
$MESS['ODNOKLASSNIKI_PUBLICATION_MODE'] = 'Update post when you change the element';
$MESS['ODNOKLASSNIKI_PUBLICATION_MODE_UPDATE'] = 'Update the post (default)';
$MESS['ODNOKLASSNIKI_PUBLICATION_MODE_DEL_ADD'] = 'Remove the old post and add new';
$MESS['ODNOKLASSNIKI_PUBLICATION_MODE_NONE'] = 'Nothing to do';
$MESS['ODNOKLASSNIKI_PUBLICATION_MODE_HELP'] = '';
