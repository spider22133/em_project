...
$MESS['VK_NAME'] = 'ВКонтакте';
$MESS['VK_ERROR'] = 'Ошибка с кодом "#CODE#" в аккаунте "#ACC_NAME#" при публикации <a href="/bitrix/admin/iblock_element_edit.php?IBLOCK_ID=#IBLOCK_ID#&type=#IBLOCK_TYPE#&ID=#ID#">элемента</a>:<br/>
	#MESSAGE# <br/>
	<a href="https://vk.com/dev/errors" target="_blank">Описание кодов ошибок ВКонтакте</a>';
$MESS['VK_SUCCESS'] = '<a href="#URL#" target="_blank">Запись</a> успешно <b>опубликована</b> через аккаунт "#ACC_NAME#"';
...
$MESS['VK_ERROR_14'] = 'Возникла ошибка при публикации <a href="/bitrix/admin/iblock_element_edit.php?IBLOCK_ID=#IBLOCK_ID#&type=#IBLOCK_TYPE#&ID=#ID#">элемента</a>, требующая от пользователя ввода капчи. Пожалуйста, перейдите в аккаунт "#ACC_NAME#", и внизу страницы введите код капчи для данного аккаунта.';
$MESS['VK_ERROR_DELETE'] = 'Ошибка с кодом "#CODE#" в аккаунте "#ACC_NAME#" при удалении <a href="/bitrix/admin/iblock_element_edit.php?IBLOCK_ID=#IBLOCK_ID#&type=#IBLOCK_TYPE#&ID=#ID#">элемента</a>:<br/>
	#MESSAGE# <br/>
	<a href="https://vk.com/dev/errors" target="_blank">Описание кодов ошибок ВКонтакте</a>';
$MESS['VK_SUCCESS_EDIT'] = '<a href="#URL#" target="_blank">Запись</a> успешно <b>обновлена</b> через аккаунт "#ACC_NAME#"';
$MESS['VK_SUCCESS_DELETE'] = '<a href="#URL#" target="_blank">Запись</a> успешно <b>удалена</b> через аккаунт "#ACC_NAME#"';
