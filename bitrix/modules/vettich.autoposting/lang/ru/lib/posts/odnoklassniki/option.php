...
#PREVIEW_TEXT#';
$MESS['ODNOKLASSNIKI_PUBLICATION_MODE'] = 'Режим обновления поста при изменении элемента инфоблока';
$MESS['ODNOKLASSNIKI_PUBLICATION_MODE_UPDATE'] = 'Обновлять сам пост (По умолчанию)';
$MESS['ODNOKLASSNIKI_PUBLICATION_MODE_DEL_ADD'] = 'Удалять старый пост и добавлять новый';
$MESS['ODNOKLASSNIKI_PUBLICATION_MODE_NONE'] = 'Ничего не выполнять';
