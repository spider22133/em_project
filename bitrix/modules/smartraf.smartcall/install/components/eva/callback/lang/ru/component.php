...
$MESS["MF_REQ_PHONE"] = "Укажите номер телефона, на который хотите получить ответ.";
$MESS["MF_REQ_TIMETOCALL"] = "Укажите удобное время для звонка";
...
$MESS["MF_ERROR_MESSAGE"] = "Ошибка:";
$MESS["SMARTRAF_SMARTCALL_ZAKAZ_OT"] = "Заказ от ";
?>