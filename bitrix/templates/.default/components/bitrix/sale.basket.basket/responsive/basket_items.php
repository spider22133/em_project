                ...
                <tr>
                    ...
                    foreach ($arResult["GRID"]["HEADERS"] as $id => $arHeader):
                        ...
                        elseif ($arHeader["id"] == "PRICE"):
                            ?>
                            <td data-th="Цена:"  class="price" id="col_<?= $arHeader["id"]; ?>">
                            <?
                        else:
                            ?>
                                ...
                                <td class="control">
                                    ...
                                    if ($bDeleteColumn):
                                        ...
                                        <a href="<?= str_replace("#ID#", $arItem["ID"], $arUrls["delete"]) ?>"
                                           title="<?= GetMessage("SALE_DELETE") ?>"><i class="fa fa-trash"
...
<!--                        --><?php //$hl_data = HL\HighloadBlockTable::getById(9)->fetch();
//
...
//                        ?>
                        ...
                        <input type="text" id="coupon" name="COUPON" value="" onchange="enterCoupon();">&nbsp;<a
            ...
            <div class="text_info text-left">
                <p>При покупке от <strong>500</strong> грн скидка <strong>5%</strong> + оформление дисконтной карты
                    на постоянную скидку <strong>5%</strong></p>
                <p>При покупке от <strong>1000</strong> грн скидка <strong>10%</strong> + оформление дисконтной
                    карты на постоянную скидку <strong>10%</strong></p>
                <p><strong>При покупке от 500 грн доставка бесплатно!</strong></p>
            </div>
        </div>
    </div>
    <?
