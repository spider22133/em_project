...
$(document).ready(function()
{
	var file_w_<?=$ALX?> = parseInt($("#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_feedback_poles").width()/5);
...
<?	for($i=1; $i<=$k; $i++):?>
	$("#alx_feed_back_theme2_<?=$ALX?> #alx_feed_back_form_file_input_add<?=$i?>")
		...
		.change(function() {
			...
			$("#alx_feed_back_theme2_<?=$ALX?> #alx_feed_back_form_filename<?=$i?>").text(myStr_<?=$ALX?>_<?=$i?>);
		});
<?	endfor?>
});
-->
...
<style type="text/css">
#alx_feed_back_theme2_<?=$ALX?>
{
	width:<?=str_replace(" ", "", $arParams["WIDTH_FORM"])?> !important;
}
#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_error_block
{
...
#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_error_list
{
	color:<?=str_replace(" ", "", $arParams["COLOR_ERROR"])?>;
	font-size:<?=str_replace(" ", "", $arParams["SIZE_INPUT"])?>;
}
#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_title_error
{
	color:<?=str_replace(" ", "", $arParams["COLOR_ERROR_TITLE"])?>;
	font-size:<?=str_replace(" ", "", $arParams["SIZE_NAME"])?>;
}
#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_mess_ok
{
	font-size:<?=str_replace(" ", "", $arParams["SIZE_NAME"])?>;
	color:<?=str_replace(" ", "", $arParams["COLOR_MESS_OK"])?>;
}
#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_feedback_poles .alx_feed_back_form_name
{
	font-size:<?=str_replace(" ", "", $arParams["SIZE_NAME"])?>;
	color:<?=str_replace(" ", "", $arParams["COLOR_NAME"])?>;
}
#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_feedback_poles .alx_feed_back_form_hint
{
	font-size:<?=str_replace(" ", "", $arParams["SIZE_HINT"])?>;
	color:<?=str_replace(" ", "", $arParams["COLOR_HINT"])?>;
}
#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_feedback_poles .alx_feed_back_form_inputtext_bg,
#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_feedback_poles .alx_feed_back_form_inputtext_bg_file,
#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_feedback_poles .alx_feed_back_form_submit_block,
#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_feedback_poles .alx_feed_back_form_file_button .alx_feed_back_form_file_button_bg
{
	-moz-border-radius:<?=str_replace(" ", "", $arParams["BORDER_RADIUS"])?>;
	  -webkit-border-radius:<?=str_replace(" ", "", $arParams["BORDER_RADIUS"])?>;
	  -khtml-border-radius:<?=str_replace(" ", "", $arParams["BORDER_RADIUS"])?>;
...
#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_feedback_poles .alx_feed_back_form_inputtext_bg input,
#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_feedback_poles .alx_feed_back_form_inputtext_bg textarea,
#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_feedback_poles .alx_feed_back_form_inputtext_bg select,
#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_feedback_poles .alx_feed_back_form_filename,
#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_feedback_poles .alx_feed_back_form_file_button_bg
{
	font-size:<?=str_replace(" ", "", $arParams["SIZE_INPUT"])?>;
	color:<?=str_replace(" ", "", $arParams["COLOR_INPUT"])?>;
	font-family:tahoma;
}
#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_feedback_poles .alx_feed_back_form_file_input_add
{
	font-size:<?=str_replace(" ", "", $arParams["SIZE_INPUT"])?>;
	color:<?=str_replace(" ", "", $arParams["COLOR_INPUT"])?>;
}
#alx_feed_back_theme2_<?=$ALX?> .alx_feed_back_form_feedback_poles .alx_feed_back_form_required_text
{
	color:red;
}
</style>
