...
<?php
            ...
            <div class="col-xs-12 col-sm-3" style="position: relative; height: 100%;" >
              <div class="total_price" data-spy="affix" data-offset-top="300">
                  <h4>Итого:</h4>
                        ...
                        <table class="bx_ordercart_order_sum" style="width: 100%;">
                            ...
                            if (strlen($arResult["PAYED_FROM_ACCOUNT_FORMATED"]) > 0)
                            {
                                ...
                                <tr>
                                    ...
                                    <td class="custom_t2 final"><?=$arResult["ORDER_TOTAL_PRICE_FORMATED"]?></td>
                                </tr>
                                <tr>
                            ...
                            else
                            {
                                ...
                                <tr>
                                    ...
                                    <td class="custom_t2 fwb final" class="price"><?=$arResult["ORDER_TOTAL_PRICE_FORMATED"]?></td>
                                </tr>
                                <?
                            }
                            ?>
                ...
                <div class="bx_ordercart_order_pay_center"><a href="javascript:void(0)" onclick="submitForm('Y'); return false;" id="ORDER_CONFIRM_BUTTON" class="checkout"><?=GetMessage("SOA_TEMPL_BUTTON")?></a></div>
          </div>
            </div>
            <script type="text/javascript">
                $('#ORDER_CONFIRM_BUTTON').click(function () {
                    gtag('event', 'conversion', { event_category: 'offer', event_action: 'buy'});
                });
            </script>
        </form>
				<?
