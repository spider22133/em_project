...
стадії виконання він знаходиться), увійдя у Ваш персональний
...
Дякуємо за покупку!";
$MESS["UP_TYPE_SUBJECT"] = "Повідомлення про надходження товару";
...
Дякуємо за покупку!";
$MESS["SALE_SUBSCRIBE_PRODUCT_SUBJECT"] = "#SITE_NAME#: Повідомлення про надходження товару";
...
Дякуємо за покупку!
";
$MESS["SALE_SUBSCRIBE_PRODUCT_HTML_TITLE"] = "Повідомлення про надходження товару в магазин #SITE_NAME#";
...
$MESS["SALE_ORDER_TRACKING_NUMBER_TYPE_NAME"] = "Повідомлення про зміну ідентифікатора поштового відправлення";
