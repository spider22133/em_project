...
$MESS['VK_NAME'] = 'VKontakte';
$MESS['VK_ERROR'] = 'Error with code "#CODE#" in the account "#ACC_NAME#" when posting <a href="/bitrix/admin/iblock_element_edit.php?IBLOCK_ID=#IBLOCK_ID#&type=#IBLOCK_TYPE#&ID=#ID#">item</a>:<br/>
	#MESSAGE# <br/>
	<a href="https://vk.com/dev/errors" target="_blank">Description of the error codes Vkontakte</a>';
$MESS['VK_SUCCESS'] = '<a href="#URL#" target="_blank">The record</a> was successfully <b>posted</b> through the account "#ACC_NAME#"';
...
$MESS['VK_ERROR_14'] = 'An error occurred while publishing <a href="/bitrix/admin/iblock_element_edit.php?IBLOCK_ID=#IBLOCK_ID#&type=#IBLOCK_TYPE#&ID=#ID#">element</a>that requires the user to enter the captcha. Please go to the "account#ACC_NAME#", and the bottom of the page enter the code captcha for this account.';
$MESS['VK_ERROR_DELETE'] = 'Error with code "#CODE#" in the account "#ACC_NAME#" when deleting <a href="/bitrix/admin/iblock_element_edit.php?IBLOCK_ID=#IBLOCK_ID#&type=#IBLOCK_TYPE#&ID=#ID#">item</a>:<br/>
	#MESSAGE# <br/>
	<a href="https://vk.com/dev/errors" target="_blank">Description of the error codes Vkontakte</a>';
$MESS['VK_SUCCESS_EDIT'] = '<a href="#URL#" target="_blank">The record</a> was successfully <b>updated</b> through the account "#ACC_NAME#"';
$MESS['VK_SUCCESS_DELETE'] = '<a href="#URL#" target="_blank">The record</a> was successfully <b>deleted</b> through the account "#ACC_NAME#"';
