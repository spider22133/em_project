		...
		<form method="post" action="<?=POST_FORM_ACTION_URI?>" name="basket_form" id="basket_form">
			<div id="basket_form_container">
				<div class="bx_ordercart <?=$templateData['TEMPLATE_CLASS']; ?>">
                    ...
                    if ($total < 500) {
                        $remain = 500 - $total;
                        echo '<div class="gem_message free_delivery"><p>До бесплатной доставки необходимо еще <strong>' . $remain . ' грн.</strong></p></div>';
                    } elseif (500 <= $total) {
                        echo '<div class="gem_message delivery_success"><p>Мы доставим Ваш заказ бесплатно!</p></div>';
                    }
...
//	ShowError($arResult["ERROR_MESSAGE"]); ?>
    <div class="text_info text-center" style="background-color: white;">
        <img src="/include/empty_cart_gem.jpg" alt="Корзина еще пуста" class="img-responsive" style="margin: 0 auto">
        <p>Упс… Еще нет покупок. Может начнем сейчас?</p>
