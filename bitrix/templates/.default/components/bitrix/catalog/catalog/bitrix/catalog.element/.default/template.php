...
?>
<div itemscope itemtype="http://schema.org/Product"  class="bx_item_detail <? echo $templateData['TEMPLATE_CLASS']; ?>" id="<? echo $arItemIDs['ID']; ?>">
    <?
    ...
    <div class="bx_item_container" >
            ...
            <div class="bx_item_slider" id="<? echo $arItemIDs['BIG_SLIDER_ID']; ?>">
                <div class="bx_bigimages" id="<? echo $arItemIDs['BIG_IMG_CONT_ID']; ?>">
                    <div class="bx_bigimages_imgcontainer">
                        <span class="bx_bigimages_aligner"><img itemprop="image" id="<? echo $arItemIDs['PICT']; ?>"
        ...
        <div class="bx_rt">
            ...
            <div class="item_price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                ...
                ?>
<!--                <div style="visibility: hidden; height: 0">--><?php //print_r($arResult['MIN_PRICE']); ?><!--</div>-->
                <span itemprop="price" class="item_current_price"
                      id="<? echo $arItemIDs['PRICE']; ?>"><? echo $minPrice['DISCOUNT_VALUE']; ?></span><span class="item_current_price" itemprop="priceCurrency">грн.</span>
                <?
                if ($arParams['SHOW_OLD_PRICE'] == 'Y') {
                    ?>
...
?>
                            ...
                            <a type="button" class="btn btn-wish js-wishlist" data-wishid="<?= $arResult["ID"] ?>"
                               title="Добавить в список желаний"
                               data-wishiblock="<?= $arResult["IBLOCK_ID"] ?>"></a></span>
                    ...
                    if ('Y' == $arParams['SHOW_MAX_QUANTITY']) {
                        if (isset($arResult['OFFERS']) && !empty($arResult['OFFERS'])) {
                            ...
                            <p  id="<? echo $arItemIDs['QUANTITY_LIMIT']; ?>"
                               style="display: none;"><? echo GetMessage('OSTATOK'); ?>: <span itemprop="availability" href="http://schema.org/InStock"></span></p>
                            <?
                        } else {
                ...
                <? if ('' != $arResult['DETAIL_TEXT']) {
                    ...
                    <div class="bx_item_description">
                        ...
                        if ('html' == $arResult['DETAIL_TEXT_TYPE']) {
                            ...
                            ?><p itemprop="description"><? echo $arResult['DETAIL_TEXT']; ?></p><?
                        }
                        ?>
                    </div>
                    <?
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="share_buttons">
                    <div class="fb-share-button" data-href="<?= $APPLICATION->GetCurPage(false) . '?v=1'; ?>"
                         data-layout="box_count" data-size="large" data-mobile-iframe="true"><a
