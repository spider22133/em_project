...
$MESS['YES'] = 'Yes';
$MESS['NO'] = 'No';
$MESS['POST_VK_PUBLISH_DATE_HELP'] = 'Select the date for the postponed publication. For delayed publication is used the the tools of social. network. (optional)';
$MESS['POST_VK_PHOTO_HELP'] = 'Select the picture that you want to invest in the post. A maximum of 10 images, with a link 9. (optional)';
$MESS['POST_VK_PHOTOS_HELP'] = 'Select the additional images that need to be put in the post. A maximum of 10 images, with a link 9. (optional)';
$MESS['POST_VK_LINK_HELP'] = 'Select the link that you need to invest in the post. (optional)';
$MESS['SAVE_BUTTON'] = 'Save';
$MESS['APPLY_BUTTON'] = 'Apply';
$MESS['VK_ACCOUNTS_GROUP_ID_STD'] = 'To use the app "auto-publishing to Facebook" instead of your';
$MESS['VK_ACCOUNTS_GROUP_ID_PLACEHOLDER'] = 'Enter the ID of Your application';
$MESS['VK_TAB_VIDEO_NAME'] = 'Video instruction';
$MESS['VK_TAB_VIDEO_TITLE'] = 'Video instruction';
$MESS['VK_EDIT_PAGE_TITLE'] = 'Edit account Vkontakte';
$MESS['POST_VK_MESSAGE_HELP'] = 'Fill in the message template. This field is <b>required</b> - if not filled fields for attachments (images, link)';
$MESS['VK_ADD_PAGE_TITLE'] = 'Add account Vkontakte';
